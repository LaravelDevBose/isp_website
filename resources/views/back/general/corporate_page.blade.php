    ...
    <div class="content">
        ...
        <div class="panel panel-info panel-bordered">
            <div class="panel-heading">
                <h5 class="panel-title">Corporate Page Information </h5>
            </div>
                    ...
                    <fieldset class="content-group row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-lg-2">Corporate Page <span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <textarea name="details"  class="form-control summernote"  cols="30" rows="40">{{ (isset($corporate->details))?$corporate->details:old('details') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" name="old_image" value="{{ (isset($corporate))?$corporate->image_path:'' }}">
                                @if($corporate)
                                    <div class="col-md-5">
                                        <img src="{{ asset($corporate->image_path) }}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
