                    ...
                    <fieldset class="content-group row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-lg-2">About us <span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <textarea name="details"  class="form-control summernote"  cols="30" rows="40">{{ (isset($aboutUs->details))?$aboutUs->details:old('details') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" name="old_image" value="{{ (isset($aboutUs))?$aboutUs->image_path:'' }}">
                                @if($aboutUs)
                                    <div class="col-md-5">
                                        <img src="{{ asset($aboutUs->image_path) }}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
