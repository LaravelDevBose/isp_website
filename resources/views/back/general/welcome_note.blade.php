...
@section('title','Welcome Note Information')
    ...
    <div class="content">
        ...
        <div class="panel panel-info panel-bordered">
            <div class="panel-heading">
                <h5 class="panel-title">Welcome Note Information </h5>
            </div>
            ...
            <div class="panel-body" id="edit_data">
                <form class="form-horizontal" action="{{ route('general.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="content-group row">
                        <input type="hidden" name="type" value="welcomeNote">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-lg-2">Welcome Note <span class="text-danger">*</span></label>
                                <div class="col-lg-10">
                                    <textarea name="details"  class="form-control summernote"  cols="30" rows="40">{{ (isset($note->details))?$note->details:old('details') }}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="hidden" name="old_image" value="{{ (isset($note))?$note->image_path:'' }}">
                                @if($note)
                                    <div class="col-md-5">
                                        <img src="{{ asset($note->image_path) }}" alt="">
                                    </div>
                                @endif
                            </div>
                        </div>
